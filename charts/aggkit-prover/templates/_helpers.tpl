...
*/}}
{{- define "aggkit-prover.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "aggkit-prover.fullname" .) .Values.serviceAccount.name }}
{{- else }}
